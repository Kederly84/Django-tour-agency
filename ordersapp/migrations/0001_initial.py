# Generated by Django 4.2.2 on 2023-11-07 21:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0002_alter_accommodation_updated_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PRD', 'обрабатывается'), ('PD', 'оплачен'), ('RDY', 'подтвержден'), ('CNL', 'отменен')], default='FM', max_length=3, verbose_name='статус')),
